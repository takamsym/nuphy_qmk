...
[3] = LAYOUT(
	...
	KC_LSFT,	KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,	KC_RSFT,	KC_UP,		KC_DEL,
	MO(4),		KC_LGUI,	KC_LALT,										KC_SPC, 							MO(4),		KC_RALT,   	KC_LEFT,	KC_DOWN,    KC_RGHT),

// layer 4 win fn
[4] = LAYOUT(
	KC_ESC, 	KC_F1,  	KC_F2,  	KC_F3, 		KC_F4,  	KC_F5,  	KC_F6,  	KC_F7,  	KC_F8,  	KC_F9, 		KC_F10, 	KC_F11, 	KC_F12,		_______,
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 	KC_DEL,
	_______, 	_______,   	_______,   	KC_INT5,  	KC_INT4,   	_______,   	KC_LEFT,	KC_DOWN,   	KC_UP,   	KC_RGHT,  	_______,   	_______,	            _______,
	KC_LSFT,    _______,   	_______,   	_______,  	_______,   	_______,   	KC_HOME,	KC_PGDN,   	KC_PGUP,	KC_END,  	_______,	KC_RSFT,	KC_PGUP,    _______,
	MO(5),		MO(6),		_______,										_______, 							_______,	_______,   	KC_HOME,	KC_PGDN,    KC_END),
...
[5] = LAYOUT(
	...
	_______, 	_______,  	_______,  	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______,    _______,
	_______, 	_______,   	_______,   	_______,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	            _______,
	_______,	_______,   	_______,   	RGB_TEST,  	_______,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,	_______,  	RGB_VAI,    _______,
	_______,	_______,	_______,										_______, 							_______,	_______,   	RGB_MOD,	RGB_VAD,    RGB_HUI),
